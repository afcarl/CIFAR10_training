...
function train(trainData)
  ...
  for t,v in ipairs(indices) do
    ...
    local inputsnew, targetsnew = augment_data(inputs,targets)
    ...
    local feval = function(x)
      ...
      local outputs = model:forward(inputsnew)
      local f = criterion:forward(outputs, targetsnew)
      local df_do = criterion:backward(outputs, targetsnew)
      model:backward(inputsnew, df_do)
	  
      confusion:batchAdd(outputs, targetsnew)
